  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sharing Application - Enabling seamless connections for a smarter, eco-friendly commute. Join us in reshaping the future of transportation."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sharing Application - Enabling seamless connections for a smarter, eco-friendly commute. Join us in reshaping the future of transportation.`}
            </Text>
            <Box
